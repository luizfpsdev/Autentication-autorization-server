...
- run --restart always --network padoca --name padoca-keycloak -p 8080:8080 keycloak-custom:1.0
...
-Obs: por enquanto devemos rodar os container na mesma base de dados
 ...
 após cada mudança: docker run -d --name padoca-keycloak --restart always --network padoca -p 8080:8080 -v $(pwd)/themes/padoca:/opt/keycloak/themes/padoca keycloak-custom:1.3  -  deve ficar atento a porta que será utilizada
